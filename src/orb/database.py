...
class Database(object):
    ...
    def setDatabaseType(self, databaseType):
        ...
        """
        self._databaseType = nativestring(databaseType)
    ...
    def setPassword(self, password):
        ...
        :param      password    <str>
        """
        self._password  = nativestring(password)
    ...
    def setUsername(self, username):
        ...
        :param      username        <str>
        """
        self._username = nativestring(username)
    ...
    def toXml(self, xparent):
        ...
        xdatabase.set('default', nativestring(self._default))
        
        if ( self.databaseType() ):
            xdatabase.set('type', self.databaseType())
        
        if ( self._host ):
            ElementTree.SubElement(xdatabase, 'host').text = nativestring(self._host)
        if ( self._port ):
            ElementTree.SubElement(xdatabase, 'port').text = nativestring(self._port)
        if ( self._username ):
    ...
    def find(name):
        ...
        :return     <Database> || None
        """
        return Database._databases.get(nativestring(name))
