...
class REST(Connection):
    ...
    def count( self, table_or_join, lookup, options ):
        ...
        if not Table.typecheck(table_or_join):
            log.debug('REST backend only supports table lookups.')
            return {}
    ...
    def serve(method,
        ...
        try:
            ...
            msg = 'Failed to load the REST options.'
        ...
        # insert a record into the database
            ...
            try:
                ...
                response['error'] = nativestring(err)
        ...
        # remove records from the database
            ...
            if 'queries' in py_data:
                ...
                for rem_data in py_data['queries']:
                    ...
                    table = _orb.model(tableName)
                    if not table:
                        continue
                    
                    for query_dict in query_list:
                        query = Q.fromDict(query_dict)
