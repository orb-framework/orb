...
PG_TYPE_MAP = {
    orb.ColumnType.Bool:        u'BOOLEAN',
    orb.ColumnType.Decimal:     u'DECIMAL',
    orb.ColumnType.Double:      u'DOUBLE PRECISION',
    orb.ColumnType.Integer:     u'INTEGER',
    orb.ColumnType.BigInt:      u'BIGINT',
    orb.ColumnType.Enum:        u'INTEGER',
    
    orb.ColumnType.Datetime:    u'TIMESTAMP WITHOUT TIME ZONE',
    ...
    orb.ColumnType.DatetimeWithTimezone:    u'TIMESTAMP WITHOUT TIME ZONE',
    
    orb.ColumnType.ForeignKey:  u'BIGINT',
    
    orb.ColumnType.Interval:    u'TIMEDELTA',
    
    orb.ColumnType.Pickle:      u'BYTEA',
    orb.ColumnType.ByteArray:   u'BYTEA',
    orb.ColumnType.Pickle:      u'BYTEA',
    orb.ColumnType.Dict:        u'BYTEA',
    orb.ColumnType.Image:       u'BYTEA'
}
...
class PostgreSQL(AbstractSQL):
    ...
    def _execute(self, 
        ...
        for key, value in data.items():
            data[key] = orb.ValueMapper.mappedValue(value)
...
if pg:
    orb.Connection.registerAddon('Postgres', PostgreSQL)
