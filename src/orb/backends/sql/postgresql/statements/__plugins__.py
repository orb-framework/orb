...
r'orb.backends.sql.postgresql.statements.create_index_sql_mako',
r'orb.backends.sql.postgresql.statements.create_table_sql_mako',
r'orb.backends.sql.postgresql.statements.create_view_sql_mako',
...
r'orb.backends.sql.postgresql.statements.schema_info_sql_mako',
...
r'orb.backends.sql.postgresql.statements.select_shortcut_sql_mako',
