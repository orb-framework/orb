...
class Index(object):
    ...
    def __call__(self, table, *values, **options):
        ...
        for i, col in enumerate(self._columnNames):
            ...
            if not column:
                ...
                logger.warning(errors.ColumnNotFoundWarning(col, tableName))
                continue
    ...
    def toXml(self, xparent):
        ...
        xindex.set('unique',  nativestring(self.unique()))
        xindex.set('cached',  nativestring(self.cached()))
        xindex.set('cachedExpires', nativestring(self._cachedExpires))
