...
class Query(object):
    ...
    def __init__(self, *args, **options):
        ...
        if len(args) == 2:
            self._table      = args[0]
            self._columnName = nativestring(args[1])
        ...
        # initialized with (column,)
            ...
            self._table      = None
            self._columnName = nativestring(args[0])
        ...
        self._name          = nativestring(options.get('name', ''))
    ...
    def __valueToDict(self, value):
        ...
        # save base types
            ...
            try:
                output['value'] = nativestring(value)
            except:
                pass
    ...
    def __valueToXml(self, xparent, value):
        ...
        # save the record
            ...
            xobject.text = nativestring(value.primaryKey())
        ...
        # save timedelta objects
            ...
            xobject.text = nativestring(value.total_seconds())
    ...
    def table(self):
        ...
        if isinstance(self._table, basestring):
            return Orb.instance().model(self._table)
        return self._table
    ...
    def toString(self):
        ...
        if symbol:
            column = '(' + column + symbol + nativestring(self.offsetValue()) + ')'
    ...
    def toXml(self, xparent=None):
        ...
        # save general info
        xquery.set('name', nativestring(self._name))
        xquery.set('op', nativestring(self._op))
        xquery.set('caseSensitive', nativestring(self._caseSensitive))
        xquery.set('negated', nativestring(self._negate))
        xquery.set('column', nativestring(self._columnName))
        ...
        if self.isOffset():
            ...
            xoffset.set('type', nativestring(self.offsetType()))
    ...
    def fromDict(data):
        ...
        out._caseSensitive = nativestring(data.get('caseSensitive')).lower() == 'true'
        out._negated = nativestring(data.get('negated')).lower() == 'true'
        out._columnName = nativestring(data.get('column'))
...
class QueryCompound(object):
    ...
    def toXml(self, xparent=None):
        ...
        xquery.set('name', nativestring(self.name()))
        xquery.set('op', nativestring(self.operatorType()))
        xquery.set('negated', nativestring(self.isNegated()))
